            ...
            GestureDetector(
              ...
              child: Column(
                children: [
                  ...
                  Text('profile.memberSince'.tr() + ': $memSince', style: const TextStyle(fontSize: 14, color: Colors.white70)),
                ],
              ),
            ),
              ...
              child: Container(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Text(
                      'profile.dailyStreak'.tr() + ': ' + 'profile.days'.tr(namedArgs: {'count': dailyStreak.toString()}),
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            // Open PreloadPage - moved inside scroll
            ElevatedButton(
              onPressed: () async {
