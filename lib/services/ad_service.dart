...
class AdService {
  ...
  // --- Production ad unit IDs (replace with yours if you changed them)
  final String _interstitialRaceUnit =
      'ca-app-pub-3327975632345057/3348615467';
  final String _interstitialChallengeUnit =
      'ca-app-pub-3327975632345057/2035533790';

  final String _rewardedHomeLifeUnit =
      'ca-app-pub-3327975632345057/6437813234';
  final String _rewardedHomePassUnit =
      'ca-app-pub-3327975632345057/6170219929';
  final String _rewardedTrainingTrialsUnit =
      'ca-app-pub-3327975632345057/3055017718';
